...
export default function LoginPage() {
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-50 to-blue-50">
      <div className="bg-white rounded-2xl shadow-xl p-10 flex flex-col items-center gap-8 w-full max-w-sm border border-gray-100">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">就勝つ</h1>
          <p className="text-gray-500 text-sm">就活選考を一元管理するシステム</p>
        </div>
